const TaktInstance = function(dataBuffer) {
    ...
    this.buzzer = (dataBuffer[40] & 0x01) > 0;
    this.prodComplete = ((dataBuffer[40] & 0x02) >> 1) > 0;
